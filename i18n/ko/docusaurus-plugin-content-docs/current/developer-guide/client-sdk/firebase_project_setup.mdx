...
Notifly를 통해 푸시 알림 및 인앱 팝업을 기기에 전송하기 위해서는 Cloud Messaging API가 활성화되어 있어야 합니다.
...
4. 클라우드 메시징 API가 활성화되었는지 확인합니다.
   ...
   - 3으로 이동하여, FCM 서버 키를 노티플라이에 등록해주세요.
