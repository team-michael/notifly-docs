...
- **유저 세그먼트 이벤트 변수 목록** 활용하여 이벤트 변수를 유저 세그먼트 설정 등에 활용할 수 있습니다. 이를 위해서, 유저 세그먼트 설정에 사용할 변수의 변수 명을 유저 세그먼트 이벤트 변수 목록 지정해주세요. \* 현재는 하나의 **유저 세그먼트 이벤트 변수**만 지원하고 있기 때문에, **유저 세그먼트 이벤트 변수 목록**은 하나만 추가하셔야 합니다.
  :::
