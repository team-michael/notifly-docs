...
| `pushSubscriptionOptions` | [NotiflyPushSubscriptionOptions](#웹-푸시-초기화-옵션) | No       | 웹 푸시 구독에 대한 옵션입니다. 자세한 설명은 위 [웹 푸시 설정](#웹-푸시-설정) 섹션을 참고해 주세요. 미입력 시 웹 푸시 서비스를 이용하실 수 없습니다.                                                                                   |
