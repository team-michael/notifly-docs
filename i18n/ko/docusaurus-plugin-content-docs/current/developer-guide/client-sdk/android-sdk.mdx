...
Notifly Android SDK에서는 푸시를 발송하기 위해 Firebase Cloud Messaging을 활용하고 있습니다. [Firebase 프로젝트 셋업](https://firebase.google.com/docs/android/setup?authuser=0&hl=ko)이 된 상태에서 초기화를 진행해 주세요.
...
`projectId`, `username`, `password`는 노티플라이 홈페이지의 설정 페이지에서 확인하실 수 있습니다.
