...
- 노티플라이에서 만든 인앱 메시지 캠페인을 Android 앱에서 띄울 수 있습니다.
  - **현재 인앱 메시지는 Android 11 (API Level 30) 이상에서만 지원되며, 이외의 디바이스에서는 인앱 메시지가 표시되지 않습니다.**
...
dependencies {
    implementation 'com.github.team-michael:notifly-android-sdk:1.1.0'
}
```
