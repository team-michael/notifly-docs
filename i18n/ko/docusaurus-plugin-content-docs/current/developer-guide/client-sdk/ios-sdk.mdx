...
- 다음 **`AppDelegate.swift`**의 `UIApplicationDelegate` 함수들 내에 각각 Notifly코드를 추가해 주세요.
    ...
    1. **`application(_:didFinishLaunchingWithOptions:)`**
        ...
        - *PROJECT_ID, USERNAME, PASSWORD* 는 [노티플라이 홈페이지의 설정 페이지](https://notifly.tech/ko/console/settings)에서 확인하실 수 있습니다.
...
- [Client SDK - 연동 Test](http://docs.notifly.tech/ko/developer-guide/client-sdk/ios-sdk) 섹션에서 테스트를 진행합니다.
