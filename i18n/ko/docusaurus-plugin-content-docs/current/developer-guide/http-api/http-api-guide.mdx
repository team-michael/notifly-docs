...
## 13. Campaign Event Data Export API
...
| isMessageDataIncluded       | Boolean | No      | message data 포함 여부 (default: false) |
...
```json
{
  ...
  "apns": {
    "payload": {
      ...
      "campaign_id": "캠페인_ID",
      "notifly_user_id": "노티플라이_유저_ID",
      "sent_time": 1234567890123,
      "notifly_message_id": "메시지_ID"
    }
  }
}
```
...
```json
{
  "token": "사용자 토큰",
  "data": {
    "notifly": "{\"type\":\"push-notification\",\"ti\":\"알림 제목\",\"bd\":\"알림 본문 내용입니다.\",\"u\":\"https://example.com/deep-link\",\"cid\":\"캠페인_ID\",\"imp\":\"normal\",\"mid\":\"메시지_ID\",\"st\":1234567890123}"
  },
  "android": {
    "priority": "high"
  }
...
## 14. Campaign Statistics API

이 endpoint를 통해 일자, 캠페인, 채널 별로 발송 성공, 실패, 도달, 클릭, 전환 수를 조회할 수 있습니다. (조회 당일 제외)
...
:::note Campaign Statistics Retrieval의 차이점
Campaign Statistics Retrieval은 캠페인을 특정해야하지만 Campaign Statistics는 요청한 기간동안 집계된 모든 캠페인/유저여정에 대해 일자별 집표 수를 제공합니다.
:::
