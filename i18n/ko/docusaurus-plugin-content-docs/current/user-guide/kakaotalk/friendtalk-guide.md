...
- 이미지
  - 파일형식 : JPG, JPEG, PNG
  - 사이즈/용량
    - 800x400(2:1비율)권장/ 10MB
    - 800x800(1:1비율)권장/ 10MB
    - 800x600(4:3비율)권장/ 10MB
...
- 이미지
  - 리스트1 이미지
    - 파일형식 : JPG, JPEG, PNG
    - 사이즈/용량 : 800x400 (2:1비율) 권장 / 10MB
  - 리스트2~4 이미지
    - 파일 형식 : JPG, JPEG, PNG
    - 사이즈/용량 : 800x800 (2:1비율) 권장 / 10MB
- 텍스트
...
- 텍스트 : 한/영 구분없이 띄어쓰기 포함 ‘제목' 20자 텍스트 + ‘문구' 180자 텍스트
