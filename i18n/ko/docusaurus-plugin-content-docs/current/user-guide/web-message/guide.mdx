...
노티플라이에서는 웹 팝업을 원하는 타이밍에, 원하는 사용자의 브라우저에 팝업을 노출시킬 수 있습니다. 웹 팝업을 띄우기 위해서 먼저 다음 작업이 선행되어야 합니다.\_createMdxContent
...
이외의 데이터는 절대 삭제하지 마세요. Notifly SDK가 정상적으로 동작하지 않을 수 있습니다.
