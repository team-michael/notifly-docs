...
수신자의 이메일 주소는 인증코드나 인증링크 등의 방법으로 인증된 유효한 이메일 주소여야 합니다. 유효하지 않은 주소로 이메일을 전송할 경우 반송되며, 10%가 넘는 반반송률은 기업 도메인 평판에 악영향을 끼칩니다. 낮은 신뢰도의 도메인으로 발송된 이메일은 더 이상 이메일 발신이 불가능하고 스팸으로 처리됩니다.
안정적인 서비스를 제공하고 평판을 보호하기 위한 [노티플라이 이메일 발송 모니터링 정책](https://github.com/team-michael/notifly-docs/edit/main/i18n/ko/docusaurus-plugin-content-docs/current/user-guide/email/guide.mdx#%EB%85%B8%ED%8B%B0%ED%94%8C%EB%9D%BC%EC%9D%B4-%EC%9D%B4%EB%A9%94%EC%9D%BC-%EB%AA%A8%EB%8B%88%ED%84%B0%EB%A7%81-%EC%A0%95%EC%B1%85)을 확인하세요.
