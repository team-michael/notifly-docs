...
![Web Push Test Message Content](./image/javacript-sdk/web-push/web_push_test_content.png)

- Click the "Send Test" button in the bottom right, enter the test user ID, and click to send the test.

![Web Push Test Sending](./image/javacript-sdk/web-push/web_push_test_result.png)
